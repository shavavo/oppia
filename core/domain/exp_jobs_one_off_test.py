...
class RuleSpecAuditOneOffJobTests(test_utils.GenericTestBase):
    ...
    def test_text_input_explorations_with_rule_specs(self):
        """Test the audit job output when there are several explorations with
        math rich text components.
        """
        ...
        self.assertEqual(
            actual_output,
            [u'[u\'TextInput-Equals\', [u\'test; exp_id0 State1\']]']
        )

    def test_set_input_explorations_with_rule_specs(self):
        """Test the audit job output when there are several explorations with
        math rich text components.
        """
        exploration_with_rule_specs = (
        ...
        state1.update_interaction_id('SetInput')
        state1.update_interaction_answer_groups([answer_group_dict])
        ...
        self.assertEqual(
            actual_output,
            [u'[u\'SetInput-Equals\', [u\'test;test2; exp_id0 State1\']]']
        )
